...
Satellite intelligence has just detected a rogue Russian aviation element inbound from the north. They are moving at maximum transit speed to seize the abandoned facility at FARP Paris. This is a straight drag race.

We need boots on the ground there first. An infantry squad—Designation: Team Anvil—is currently staging at the Northern End of your tarmac. You are ordered to taxi immediately, load them into your cabin, and scramble to the northwest.

High threat, Vanguard. Radar tracks confirm the Russian transport flight is being escorted by heavy attack choppers. Ground crews won't have time to re-vamp your whole rack, but they are sprinting out to strap short-range air-to-air missiles to your pylons right now. You are going to have to fight for the airspace.
...
Airspace clear. Green smoke at capture.

Deploy ground units to secure the FARP.
